...
class Server():
    ...
    def show_testing_result(self,my_data,plot):
            ...
            # validation
            self.acc_test, self.loss_test, self.acc_per_label, self.poison_acc = test_img_poison(self.client_net.to(f.device), my_data.dataset_test, my_data.dataset_test_poison)
            ...
            print( " Testing accuracy: {} loss: {:.6}".format(self.acc_test, float(self.loss_test)))
